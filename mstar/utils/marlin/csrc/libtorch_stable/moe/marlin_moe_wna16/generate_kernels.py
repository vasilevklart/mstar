...
# mstar: trimmed to GPTQ symmetric INT4 (kU4B8) with fp16/bf16 activation only —
# the sole scheme Kimi-K2.7 (compressed-tensors W4A16) uses. All the AWQ / INT8 /
# FP8 / NVFP4 / MXFP4 / W4A8 variants are dropped so the JIT compile stays small.
# Upstream QUANT_CONFIGS kept in git history if another scheme is ever needed.
QUANT_CONFIGS = [
    # GPTQ-INT4
    {
        "b_type": "kU4B8",
