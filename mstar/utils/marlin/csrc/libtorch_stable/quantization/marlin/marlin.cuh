// Marlin common device header, vendored VERBATIM from vLLM (Apache-2.0).
//
// Source: vllm-project/vllm  csrc/libtorch_stable/quantization/marlin/marlin.cuh
// Self-contained: includes only <cuda*.h> + <iostream>. Provides the Marlin
// tile/thread constants and the cp.async helpers used by the repack and GEMM
// kernels. Kept byte-identical to upstream so future syncs are a clean diff.
//
